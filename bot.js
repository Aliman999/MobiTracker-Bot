...
tips.tips = [
  ...
  "**[TIP]:** :tada: ```Subbing to our patreon will bump you up in priority! See our #📜faq channel for more information```",
...
async function addQueue(message, args){
  ...
  jobQueue.schedule({ id:message.author.tag, priority:message.author.prio }, lookUp, args.length, message, args, msg);
}
