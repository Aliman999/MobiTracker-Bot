                      ...
                      if(ii == argz.length-1){
                        ...
                        if(registeredCID.length > 0){
                          ...
                          for(var xx = 0; xx < registeredCID.length; xx++){
                            const sql = "INSERT INTO `players` ( `cID`, `username`, `password`, `email`, `avatar`, `verify`) VALUES ( ?, '"+registeredName[xx]+"', '"+password+"', 'Discord', '"+registeredAvi[xx]+"', 1);";
                            console.log(sql);
                            con.query(sql, [registeredCID[xx]]);
                          }
                        }
