...
client.on('message', message => {
  ...
  if (command === 'search'){
    ...
    if(!args.length){
      return message.channel.send('Sign in at https://mobitracker.co/login and click the button that says Auth at the top and copy the text provided and paste it here.');
